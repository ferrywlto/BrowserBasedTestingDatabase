...
CREATE TABLE TestCase (
  idTestCase VARCHAR(255) NOT NULL,
  ...
  INDEX TestCase_FKIndex1(tcCategory),
...
CREATE TABLE TestRecords (
  ...
  INDEX TestRecords_FKIndex1(trTestID),
  INDEX TestRecords_FKIndex2(trTestCaseID),
  ...
  FOREIGN KEY(trTestID)
    REFERENCES Test(idTest)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY(trTestCaseID)
    REFERENCES TestCase(idTestCase)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
